...
namespace AsyncProgramming {
    internal class GetStringLengthEventArgs : AsyncCompletedEventArgs {
    ...
    public class TaskCompletionSourceSamples {
        ...
        private static void StringConverterGetStringLengthCompleted(object sender, GetStringLengthEventArgs e) {
            if (e.Error != null) {
        ...
        public static async void GetStringLengthAsync(string str) {
            try {
                var result = await GetStringLengthTaskAsync(str);
